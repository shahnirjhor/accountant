                    ...
                    <form class="form-material form-horizontal" action="{{ route('currency.update', $data) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label for="exampleInputPassword1">{{ __('Code') }} <b class="ambitious-crimson">*</b></label>
                                <div class="form-group input-group mb-3">
                                    <div class="input-group-prepend">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="exampleInputPassword1">{{ __('Rate') }} <b class="ambitious-crimson">*</b></label>
                                    <div class="form-group input-group mb-3">
                                        <div class="input-group-prepend">
                                ...
                                <div class="col-md-6">
                                    <label for="exampleInputPassword1">{{ __('Precision') }} <b class="ambitious-crimson">*</b></label>
                                    <div class="form-group input-group mb-3">
                                        <div class="input-group-prepend">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="exampleInputPassword1">{{ __('Symbol') }} <b class="ambitious-crimson">*</b></label>
                                    <div class="form-group input-group mb-3">
                                        <div class="input-group-prepend">
                                ...
                                <div class="col-md-6">
                                    <label for="exampleInputPassword1">{{ __('Symbol Position') }} <b class="ambitious-crimson">*</b></label>
                                    <div class="form-group input-group mb-3">
                                        <div class="input-group-prepend">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="exampleInputPassword1">{{ __('Decimal Mark') }} <b class="ambitious-crimson">*</b></label>
                                    <div class="form-group input-group mb-3">
                                        <div class="input-group-prepend">
                                ...
                                <div class="col-md-6">
                                    <label for="exampleInputPassword1">{{ __('Thousands Separator') }} <b class="ambitious-crimson">*</b></label>
                                    <div class="form-group input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-columns"></i></span>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group input-group mb-3">
                                        ...
                                        <select class="form-control ambitious-form-loading @error('default_currency') is-invalid @enderror" required="required" name="default_currency" id="default_currency">
                                            <option value="1" @if($company->default_currency == $data->code) selected @endif>{{ __('Yes') }}</option>
                                            <option value="0" @if($company->default_currency != $data->code) selected @endif>{{ __('No') }}</option>
                                        </select>
